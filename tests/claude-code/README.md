...
### Run specific test:
```bash
./run-skill-tests.sh --test test-example-skill.sh
```
...
No tests currently configured. Add new tests following the pattern below.
...
```bash
./run-skill-tests.sh --verbose --test test-example-skill.sh
```
