...
description: Use when developing a complete feature from idea through brainstorming, implementation, manual testing to completion - orchestrates the full development workflow with isolated worktrees
---
...
Remember, set these variables at the start of the workflow:
